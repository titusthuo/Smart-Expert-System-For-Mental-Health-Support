...
const variantClasses: Record<Variant, string> = {
  heading:
    "text-[30px] font-extrabold tracking-[-0.8px] leading-[36px] text-foreground",
  subheading:
    "text-[14px] font-normal leading-[20px] mt-1.5 text-muted-foreground",
  ...
  brandSub:
    "text-[11px] font-normal mt-0.5 tracking-[0.2px] text-muted-foreground",
  sectionLabel:
...
export function AppText({
  ...
  const baseClass = unstyled ? "" : variantClasses[variant];
